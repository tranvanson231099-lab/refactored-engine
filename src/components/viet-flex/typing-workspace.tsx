  ...
  return (
    <div className="flex-1 flex flex-col gap-4">
      ...
      <Alert className="bg-blue-50 border-blue-200">
        ...
        <AlertTitle className="text-xs font-bold text-blue-800">Tự động sửa lỗi đã kích hoạt</AlertTitle>
        <AlertDescription className="text-[10px] text-blue-700">
          VietFlex Engine 2.0 tự động đưa dấu về đúng vị trí (ví dụ: luýên &rarr; luyến) ngay khi bạn gõ. Hoạt động offline 100%.
        </AlertDescription>
      </Alert>

      <div className="relative group">
        <Textarea
          placeholder={isEnabled ? "Nhập văn bản (Ví dụ: sonw -> sơn, thuyeenf -> thuyền)..." : "IME is currently disabled..."}
      ...
      <div className="p-4 bg-primary/5 rounded-lg border border-primary/10">
        <h3 className="text-xs font-bold uppercase tracking-widest text-primary mb-2 flex items-center gap-2">
          ...
          Mẹo gõ siêu tốc (v2.0)
        </h3>
        <p className="text-xs text-muted-foreground leading-relaxed">
          - <b>Sơn/Hư</b>: Gõ <code>sonw</code>, <code>huw</code> (phím <code>w</code> thêm móc tức thì).<br />
          - <b>Sửa lỗi luýên</b>: Gõ dấu ở bất kỳ đâu, Engine 2.0 sẽ tự đưa dấu về chữ <code>ê</code>.<br />
          - <b>Gõ lặp</b>: Gõ <code>ww</code> &rarr; w, <code>aa</code> &rarr; a để thoát chế độ tiếng Việt.<br />
          - <b>Xóa dấu</b>: Gõ lại phím dấu cũ để xóa (Ví dụ: <code>as</code> &rarr; á, gõ thêm <code>s</code> &rarr; a).
        </p>
      </div>
    </div>
  );
